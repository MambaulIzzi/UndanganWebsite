...
import pria from '../../Img/compress/pria.png'
import wanita from '../../Img/compress/wanita.png'
import AOS from 'aos';
  ...
  return (
    <>
      <div className='my-16'>
        ...
        <h1 className='text-center text-3xl font-semibold arial mx-4 mb-2 text-[#477aa9]' data-aos="fade-up">بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيْمِ</h1>
        <p className='text-center arial text-[#477aa9] font-bold mb-2' data-aos="fade-up">Assalamualaikum Wr Wb</p>
        <p className='text-center arial text-[#477aa9] text-sm mx-4 md:mx-48 mb-4' data-aos="fade-up">
        ...
        <div id="mempelai" className='grid md:grid-cols-2 grid-cols-1 gap-4 lg:mx-32 mx-4'>
          <div>
            ...
            <h1 data-aos="fade-up" className='text-center custom-font-3 md:text-2xl text-lg text-[#477aa9] font-bold mb-4'>Mempelai Pria</h1>
            <h1 data-aos="fade-up" className='text-center custom-font-2 lg:text-6xl text-4xl text-[#477aa9] font-bold mb-2'>Obi Adama Alfonso</h1>
            <p data-aos="fade-up" className='text-[#477aa9] font-semibold text-center md:text-lg text-sm'>Putra Pertama dari <br /> Bapak Tasrizal (Alm) & Ibu Opi Usmidarti</p>
          </div>
          <div>
            <center>
              <img src={wanita} alt='mempelai-pria' data-aos="fade-up" loading="lazy" className='w-[400px]' />
            </center>
            <h1 data-aos="fade-up" className='text-center custom-font-3 md:text-2xl text-lg text-[#477aa9] font-bold mb-4'>Mempelai Wanita</h1>
            <h1 data-aos="fade-up" className='text-center custom-font-2 lg:text-6xl text-4xl text-[#477aa9] font-bold mb-2'>Siska Febrianingsih</h1>
            <p data-aos="fade-up" className='text-[#477aa9] font-semibold text-center md:text-lg text-sm'>Putri Bungsu dari <br /> Bapak Heriadi & Ibu Sundari</p>
          </div>
        </div>
      </div>
      <div className='mb-16 mt-24 bg-[#477aa9] flex justify-center'>
