    ...
    return (
        <>
            <div className={`fixed w-full h-full z-20 ${transformUp === true ? 'translate-y-[-700px] opacity-0' : ''} duration-700 cover-1`}>
                <div className='absolute bg-[#4577a8] w-full h-full'></div>
                <div className='absolute w-full h-full'>
                    <div className='absolute top-1/4 left-0 right-0'>
                        <div className='text-center'>
                            ...
                            <button type="button" onClick={onClick} class="text-white text-md bg-[#f5a525] hover:bg-[#31261d] font-bold rounded-xl px-5 py-3.5 mr-2 mb-2">
